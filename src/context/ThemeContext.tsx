...
export const ThemeProvider: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  const normalizedSystemTheme: ThemeMode = systemScheme === "light" ? "light" : "dark";
  const resolvedTheme = theme === "system" ? normalizedSystemTheme : theme;

  // Select color palette
  const colors = resolvedTheme === "dark" ? customDarkTheme : customLightTheme;

  const contextValue: ThemeContextType = { theme, setTheme, colors, toggleTheme };
